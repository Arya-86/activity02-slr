...
```{r load-data}
hfi <- read_csv('~/R/STA_631/activity02-slr/hfi.csv')
...
```{r variables_of_int}
skimr::skim(hfi_2016$pf_expression_control)
...
hfi_2016 %>% 
  ggplot(aes(pf_expression_control))+
  geom_histogram(fill = "cornflowerblue", 
                 color = "white")+
  labs(title = "Distribution of the Political Pressures and Controls on Media Content Index",
       x = "Political Pressures and Controls on Media Content Index Score") +
  theme_minimal()
...
The first plot displays the spread of the distribution of Personal Freedom Score which is left skewed, there are a few outliers on the left side of the plot, indicating there are only a few countries with low 'personal freedom score'.
The second plot shows the Distribution of the Political Pressures and Controls on Media Content Index, which has a pretty flat bell curve, indicating a normal distribution with most of the data points clustered around the center.
...
I would use a scatterplot to display the relationship between the personal freedom score, `pf_score`, and the political pressures and controls on media content index,`pf_expression_control`
...
hfi_2016 %>% 
  ...
  labs(title = "Relationship between Political Pressures and Controls on Media Content on Personal Freedom Score",
       x = "Political Pressures and Controls on Media Content Index Score",
...
```{r challenge}
#summary of personal freedom score and Political Pressures and Controls on Media Content Index

describe(hfi_2016[ , c('pf_expression_control', 'pf_score')], fast=TRUE)
